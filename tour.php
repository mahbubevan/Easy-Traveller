...
<body>
  ...
  require('mysqlconnection.php');
      ...
      echo '<div class="container tour-pack">';
                ...
                while($row=$result->fetch_assoc()){
                  echo '
                    ...
                    <div class="card" style="width:400px;height:500px;">
                      <img class="card-img-top img-fluid" src="uploads/'.$row['img'].'" alt="Card image">
                      <div class="card-body">
                        <form action="bookingpage.php" method="GET">
                          <h4 class="card-title">'. $row['packageid'].' '. $row['packagename'] .'</h4>
                          <p class="card-text">'. $row['details'].'</p>
                          <p class="card-text">'. $row['availabledate'].'</p>
                          <p class="card-text">'. $row['cost'].'</p>
                          <input type="hidden" name="pid" value="'.$row['packageid'].'">
